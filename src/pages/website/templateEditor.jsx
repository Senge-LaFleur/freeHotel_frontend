        ...
        <div className="template-editor">
                        ...
                        <div className="sidebar-section-content">
                            <div className="editor-section">
                                ...
                                <input
                                    ...
                                    onChange={e => setGeneralPadding(Number(e.target.value))}
                                />
                                <span style={{ fontSize: '0.95rem', color: '#888' }}> {generalPadding}px</span>
                            </div>
                            {/* Padding (future) */}
                        ...
                        <div className="sidebar-section-content">
                            ...
                            <div className="editor-section">
                                ...
                                <div style={{ display: 'flex', gap: '0.5rem', flexWrap: 'wrap' }}>
                                    <input value={roomFilterOptions.type.join(',')} onChange={e => setRoomFilterOptions(o => ({ ...o, type: e.target.value.split(',').map(s => s.trim()) }))} placeholder="Types (comma separated)" />
                                    <input value={roomFilterOptions.beds.join(',')} onChange={e => setRoomFilterOptions(o => ({ ...o, beds: e.target.value.split(',').map(s => s.trim()) }))} placeholder="Beds (comma separated)" />
                                </div>
                            </div>
                            <div className="editor-section">
                                <label>Rooms</label>
                            ...
                            >
                                ...
                                {mobileMenuOpen && (
                                    <div className="editor-nav-links-mobile" style={{
                                        ...
                                        <span style={{ margin: '0.5rem 0', cursor: 'pointer' }}>About</span>
                                        <span style={{ margin: '0.5rem 0', cursor: 'pointer' }}>Contact</span>
                                    </div>
                                )}
                            </div>
                        ) : (
                        ...
                        <div style={{ position: 'relative', zIndex: 1, width: '100%', display: 'flex', flexDirection: 'column' }}>
                            ...
                            >
                                ...
                                <div style={{ display: 'flex', flexWrap: 'wrap', gap: '2rem', justifyContent: 'center' }}>
                                    {rooms.filter(r =>
                                        (roomFilters.type === '' || r.name.toLowerCase().includes(roomFilters.type.toLowerCase())) &&
                                        (roomFilters.price === 'under99' ? r.price < 99 : roomFilters.price === '99-199' ? r.price >= 99 && r.price < 200 : r.price >= 199 && r.price < 300) &&
                                        (roomFilters.beds === '' || true) // beds logic placeholder
                                    ).map((r, idx) => (
                                        <div key={idx} style={{ background: '#fff', borderRadius: 12, boxShadow: '0 2px 12px rgba(0,0,0,0.08)', width: 240, padding: 16, display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
                            ...
                            >
                                <div style={{ display: 'flex', flexWrap: 'wrap', justifyContent: 'space-between', alignItems: 'flex-start', gap: '2rem', maxWidth: 1200, margin: '0 auto' }}>
            ...
            {showPreview && (
                <div className="editor-preview-modal">
                    <div
                        className={`editor-preview-full ${previewMode}`}
                    ...
                    >
                        ...
                        <div style={{ position: 'relative', zIndex: 1, width: '100%', minHeight: '100vh', display: 'flex', flexDirection: 'column' }}>
                            ...
                            {/* About Section Preview in Modal */}
                            <section
                                className="about-section-preview"
                                style={{
                                    background: aboutBgColor,
                                    padding: `${aboutPadding}px 0`,
                                    display: 'flex',
                                    flexDirection: aboutLayout === 'center' ? 'column' : 'row',
                                    alignItems: 'center',
                                    justifyContent: aboutLayout === 'center' ? 'center' : 'space-between',
                            ...
                            {/* Amenities Section Preview in Modal */}
                            <section
                                className="amenities-section-preview"
                                style={{
                                    background: amenitiesBgColor,
                                    padding: `${amenitiesPadding}px 0`,
                                    marginTop: '0',
                                }}
                            >
                                <div style={{
